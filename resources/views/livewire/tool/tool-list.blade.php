<div class="py-2">
    <div class="max-w-12xl p-4 mx-auto"> {{--breedte van tabel, centreren op ruimte--}}
        ...
        @if($checked)
            geselecteerde tools :@foreach($checked as $tool)
                {{$tool}}
            @endforeach
        @endif
            ...
            <div class="grid grid-cols-2 sm:grid-cols-6 gap-2 lg:grid-cols-6 xl:grid-cols-10 ">
                ...
                @forelse($tools as $tool)
                    ...
                    <div @class([
                        ...
                        <div class="p-2">
                            <div class="flex justify-center">
                                <img class="mx-auto object-scale-down h-24 w-24 place-content-center"
                                     src="{{asset('storage/img/'.$tool->kind->img) ?? asset('storage/img/logo.jpg')}}"
                                     alt="No Pic">
                            ...
                            <div @class (['invisible'=>$u])>
                                ...
                                @else
                                    <button
                                        class="font-serif bg-gray-200 hover:bg-red-500 hover:text-white rounded px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 w-full"
                            ...
                            <div
                                class="inline-block bg-gray-200 rounded px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2 h-16 w-full  text-center">
                            ...
                            <div
                                @class(['text-red-500'=>$t,'font-extrabold'=>$t])class="inline-block bg-gray-200 rounded px-3 py-1 text-sm text-gray-700 mr-2 mb-2 w-full text-center">
                                DueTime: <br/>
        ...
        @if (session()->has('message'))
            <div
                class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 bg-green-200 px-4 py-3 shadow-md my-3"
                role="alert"
                x-data="{open: true}"
